import { Bot, Disc3, Gamepad2, MapPinned, Music2, type LucideIcon } from 'lucide-react';
...
export type Project = {
  ...
  href: string;
  icon: LucideIcon;
  accent: 'nexus' | 'jarvin' | 'cipher' | 'autochess' | 'trackextract';
  brand?: {
    alt: string;
    icon: string;
  ...
  demo: {
    kind: 'nexus' | 'jarvin' | 'cipher' | 'autochess' | 'trackextract';
    label: string;
    metric: string;
    summary: string;
    steps: string[];
